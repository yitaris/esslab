...
export default function Fetchsandivic() {
  const { data, loading, fetchInventory, updateInventory } = useSupabase();
  ...
  useEffect(() => {
    fetchInventory("sandivic"); // Fetch items with the category "paket"
  }, []);

  const handleSave = async (id) => {
    await updateInventory(id, { productcount: editedValue });
    setEditMode(null);
    fetchInventory("sandivic"); // Refresh inventory after update
  };
